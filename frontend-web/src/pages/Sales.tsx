        ...
        <div className="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-50">
          <div className="bg-[#243D66] rounded-t-2xl sm:rounded-xl shadow-xl w-full max-w-2xl sm:mx-4 max-h-[95vh] sm:max-h-[92vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div className="bg-[#172A46] rounded-xl p-4 space-y-3">
                ...
                {selectedProduct && (
                  <>
                    ...
                    <div className="grid grid-cols-[1fr_auto_auto_auto] gap-2 items-end">
                      ...
                      <div>
                        <label className="text-xs text-[#6B7280] mb-1 block">Precio</label>
                          ...
                          {(['a', 'b', 'c'] as const).map(t => {
                            ...
                            return (
                              <button key={t} type="button" disabled={pr == null}
                                ...
                                className={`px-3 py-2 text-xs font-bold transition-colors disabled:opacity-30 disabled:cursor-not-allowed ${selTier === t ? (t === 'a' ? 'bg-[#D4AF37] text-[#0F0F0F]' : t === 'b' ? 'bg-green-600 text-white' : 'bg-orange-500 text-white') : 'bg-[#243D66] text-[#6B7280] hover:bg-[#1E3557]'}`}>
                      ...
                      <div>
                        <label className="text-xs text-[#6B7280] mb-1 block">Cant.</label>
                        <input value={selQty} onChange={e => setSelQty(e.target.value)} type="number" min="1"
                          className="w-20 border border-white/10 rounded-lg px-3 py-2 text-sm text-center focus:outline-none focus:ring-2 focus:ring-[#D4AF37]" />
                      </div>
              ...
              <div className="bg-[#172A46] rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-3">
                  <label className="text-sm font-medium text-gray-300 w-32">Descuento %</label>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-base font-bold text-gray-100">Total a cobrar</span>
              ...
              <div>
                ...
                <textarea value={notes} onChange={e => setNotes(e.target.value)} rows={2}
                  className="w-full border border-white/10 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#D4AF37] resize-none"
