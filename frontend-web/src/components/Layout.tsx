...
const navItems: NavItem[] = [
  ...
  { to: '/customers',  label: 'Clientes',   icon: '◎', roles: ['admin', 'ejecutivo', 'vendedor'], perm: 'view_customers'    },
  { to: '/categories', label: 'Categorías', icon: '◇', roles: ['admin', 'ejecutivo', 'vendedor'], perm: 'manage_categories' },
