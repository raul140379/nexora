            ...
            <View style={styles.card}>
              <View style={styles.cardTop}>
                ...
                <View style={styles.actions}>
                  <View style={[styles.badge, { backgroundColor: c.is_active ? 'rgba(74,222,128,0.15)' : 'rgba(148,163,184,0.1)' }]}>
                    <Text style={{ fontSize: 10, color: c.is_active ? '#4ade80' : '#64748b' }}>
        ...
        <View style={styles.overlay}>
          <ScrollView contentContainerStyle={styles.modalBox} keyboardShouldPersistTaps="handled">
            ...
            <TextInput style={styles.input} value={form.email} onChangeText={t => setForm(p => ({ ...p, email: t }))}
              placeholder="correo@ejemplo.com" placeholderTextColor="#4a6fa5" keyboardType="email-address" autoCapitalize="none" />
            ...
            <View style={styles.modalBtns}>
              ...
              <TouchableOpacity style={[styles.saveBtn, saving && { opacity: 0.5 }]} onPress={handleSave} disabled={saving}>
                {saving ? <ActivityIndicator color="#0F0F0F" /> : <Text style={styles.saveBtnText}>{editingId ? 'Actualizar' : 'Crear cliente'}</Text>}
              </TouchableOpacity>
            </View>
          </ScrollView>
        </View>
